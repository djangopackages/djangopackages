    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "created",
                    core.fields.CreationDateTimeField(
                ...
                (
                    "modified",
                    core.fields.ModificationDateTimeField(
                        default=django.utils.timezone.now,
                ...
                (
                    "title_plural",
                    models.CharField(
                        max_length="50", verbose_name="Title Plural", blank=True
                    ),
                ),
                (
                    "show_pypi",
                    models.BooleanField(
                        default=True, verbose_name="Show pypi stats & version"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "repo_description",
                    models.TextField(verbose_name="Repo Description", blank=True),
                ),
                (
                    "repo_url",
                    models.URLField(
                ...
                (
                    "repo_watchers",
                    models.IntegerField(default=0, verbose_name="repo watchers"),
                ),
                (
                    "repo_forks",
                ...
                (
                    "commit_list",
                    models.TextField(verbose_name="Commit List", blank=True),
                ),
                (
                    "category",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "number",
                    models.CharField(
                        default="", max_length="100", verbose_name="Version", blank=""
                    ),
                ),
                ...
                (
                    "upload_time",
                    models.DateTimeField(
                        help_text="When this was uploaded to PyPI",
                        null=True,
                        verbose_name="upload_time",
                        blank=True,
                    ),
                ),
                (
                ...
                (
                    "supports_python3",
                    models.BooleanField(
                        default=False, verbose_name="Supports Python 3"
                    ),
                ),
                (
                    "package",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                to="package.Package", on_delete=django.db.models.deletion.CASCADE
            ),
