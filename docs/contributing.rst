...
Follow our detailed `installation`_ instructions. Please record any difficulties you have and share them with the Django Packages community via our `issue tracker`_.
