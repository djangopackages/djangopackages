    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "slug",
                    models.SlugField(
                        help_text="Slugs will be lowercased",
                        unique=True,
                        verbose_name="Slug",
                    ),
                ),
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Moderators can lock grid access",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "grid",
                    models.ForeignKey(
                        to="grid.Grid", on_delete=django.db.models.deletion.CASCADE
                    ),
                ),
                (
                    "package",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                to="package.Package", through="grid.GridPackage"
            ),
        ...
        migrations.AddField(
            ...
            name="feature",
            field=models.ForeignKey(
                to="grid.Feature", on_delete=django.db.models.deletion.CASCADE
            ),
            preserve_default=True,
        ),
        migrations.AddField(
            ...
            name="grid_package",
            field=models.ForeignKey(
                to="grid.GridPackage", on_delete=django.db.models.deletion.CASCADE
            ),
            preserve_default=True,
        ),
    ]
