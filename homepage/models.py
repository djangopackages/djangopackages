...
class Dpotw(BaseModel):
    ...
    def __str__(self):
        return '{} : {} - {}'.format(self.package.title, self.start_date, self.end_date)
...
class Gotw(BaseModel):
    ...
    def __str__(self):
        return '{} : {} - {}'.format(self.grid.title, self.start_date, self.end_date)
...
class PSA(BaseModel):
    ...
    def __str__(self):
        return "{} : {}".format(self.created, self.body_text)
